...
MesosContainerizerLaunch::Flags::Flags()
{
  ...
  add(&directory,
      "directory",
      "The directory to chdir to. If rootfs is specified it must\n"
...
int MesosContainerizerLaunch::execute()
{
  ...
  // a container root filesystem is user.
  ...
  // Enter working directory. This must be an absolute path, relative
  // to the new root.
